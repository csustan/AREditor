...
function Viewport( editor ) {
	...
	//Small grid
	const grid1 = new THREE.GridHelper( 15, 30, 0x222222  ); ////size, division, color. By setting the size to half the divion gets you 1/4 cuts, which is useful for mesurement
	grid1.material.color.setHex( 0x222222 );
	grid1.material.vertexColors = false;
	grid.add( grid1 );

	//Large grid
	const grid2 = new THREE.GridHelper( 15, 15, 0x222222 ); //size, division, color. By setting the size and division to the same vaule, you get one unit, which is useful for mesurement
